...
const levelLayout = [
  ...
  ['W',' ',' ',' ',' ',' ',' ',' ','T',' ',' ',' ',' ',' ',' ','T',' ',' ',' ','W'],
  ['W',' ',' ',' ',' ',' ',' ','T','T','T',' ',' ',' ',' ','T','T','T',' ','G','W'],
  ['W',' ',' ','W','W','W','W','T','T','T','W','W','W','W','T','T','T','W','W','W'],
  ['W','P',' ',' ',' ',' ','W','T','T','T',' ',' ',' ',' ','T','T','T','W','W','W'],
...
const levelLayout = [
  ...
  ['W',' ',' ',' ','W',' ',' ','W','T','T',' ',' ',' ',' ','W','T','T',' ',' ','W'],
  ['W',' ',' ',' ','W',' ',' ','W','T','T',' ',' ',' ',' ','W','T','T',' ','G','W'],
  ['W',' ',' ',' ','W',' ',' ','W','T','T','T','W','W','W','T','T','T','W','W','W'],
  ['W','P',' ',' ',' ',' ',' ','W','T','T','T','T','T','T','T','T','T','W','W','W'],
  ['W',' ',' ',' ',' ',' ',' ','W','W','W','T','T','T','T','T','T','T','W','W','W'],
  ['W','W','W','W','W','W','W','W','W','W','W','W','W','W','W','W','W','W','W','W']
];
